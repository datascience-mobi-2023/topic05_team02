...
# create a function to calculate the mean, median, and quantiles for a row
...
```{r}
plot(prism[,1], xlab = "cell lines", ylab= "treatment effect")
abline(h = 0, col="red")
...
pheatmap(prism.exp.kidney)
pheatmap(t(prism.exp.kidney))
```
