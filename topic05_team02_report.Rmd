...
Cancer is one of the leading death causes worldwide with a new case incidence of 442.4 per 100,000 people and 10 million deaths per year.
...
Drug repurposing is a very promising way to reduce the invevstment into finding new treatments.

There are several different computational and experimental approaches to drug repurposing but the overall aim is to identify an unknown effect of a known drug.
...
This method has different advantages: It is safer, because most of the drugs have already been tested in preclinical studies so the risk of failure due to toxicity for example is lower.
Economizing the preclinical trials also reduces the development time and cost.
Investment becomes more attractive because the its return is more likely and quicker.
...
AS fpr every developmental method drug repurposing has a risk of failure and limitations, including regulatory and organizational hurdles, as well as patent considerations.
...
Achilles is a CRISPR/Cas loss-of-function screen. Genes are selectively knocked-out to test cell viability/
Identification of cancer-specific gene targets permits more selective killing of cancerous cells instead of the general cell toxicity of known drugs.
...
The question on which similarity characteristic the clustering happens.
