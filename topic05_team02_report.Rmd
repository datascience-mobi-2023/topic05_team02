...
prism.cluster.1.moa<-table(prism.cluster1$moa)[cccc1]
...
ggplot(prism.treat.high_effect_drugs$target, aes(x = Hugo_Symbol, fill = Variant_Classification)) +
  geom_bar() +
  scale_fill_manual(values = color_palette) +
  labs(x = "gene", y = "Number of mutations", title = "Variant classifications of possible target genes") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 55, hjust = 1))
#dose
